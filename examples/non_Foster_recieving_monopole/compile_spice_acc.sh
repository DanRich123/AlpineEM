...
OPT_FLAGS="-O3 -acc=gpu -Mpreprocess -Duse_spice_version"
...
nvfortran ${OPT_FLAGS} fdtd_solver.o circuit.o ngspice_interface.o ngspice_interfaces.o -L${INSTALL_DIR}/ngspice-sf-mirror-ngspice-44.2/local/lib -lngspice -o FDTD-SPICE-ACC