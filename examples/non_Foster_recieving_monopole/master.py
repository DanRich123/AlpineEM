...
times=15000
factor=1
base_time_step=9.4365835E-13 # get from a clear case or test run (fixed based on position deltas)
...
f.write('{}\n'.format(times)) #time steps
f.write('{}\n'.format(factor)) #time step reduction factor - CFL*0.98/factor
...
#recall kmax+spice requires duplicate ports with different naming and identities for real+imag splitting
