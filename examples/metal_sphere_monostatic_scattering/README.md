...
This example is designed to teach and validate the core mechanisms of the solver including the Total Field / Scattered Field formalism (TF/SF), the convolutional perfecly matched layer (CPML) boundaries, the Near-to-Far-Field transformation (NTFF), and the three builder options (single-threaded CPU, multi-threaded CPU (OpenMP), and the GPU (OpenACC)).
...
<p align="center">
  <img src="./geometry.png" alt="Model geom" width="30%" />
</p>
