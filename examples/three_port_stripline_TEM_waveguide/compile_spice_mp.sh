...
OPT_FLAGS="-O3 -qopenmp -fpp -Duse_spice_version"
...
ifx ${OPT_FLAGS} fdtd_solver.o circuit.o ngspice_interface.o ngspice_interfaces.o -L${INSTALL_DIR}/ngspice-sf-mirror-ngspice-44.2/local/lib -lngspice -o FDTD-SPICE-MP